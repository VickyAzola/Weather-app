...
function App() {
  ...
  const handleSelectedLocation = async (location: GeocodingResult) => {
  ...
  return (
    <>
      ...
      <main className="px-4 pt-4 pb-10 flex flex-col lg:px-20">
        ...
        >
          <div className="relative w-full lg:w-lg">
            <input
              ...
              className=" bg-NeutralBlue-800 text-NeutralWhite-0 pl-14 pr-3 py-3 cursor-pointer outline-none *:focus-within:border-NeutralWhite-0 
                w-full rounded-lg border border-transparent transition-all duration-200
                focus-within:ring-2 focus-within:ring-NeutralWhite-0/90 focus-within:ring-offset-2 focus-within:ring-offset-NeutralBlue-900"
            ></input>
            <img
              src={iconSearch}
              alt="Search icon"
          ...
          <button
            type="submit"
            className="bg-Blue-500 hover:bg-Blue-700 border border-NeutralBlue-900 cursor-pointer text-NeutralWhite-0 p-3 lg:px-5 rounded-lg w-full lg:w-auto transition-all duration-200  
          focus:bg-Blue-500 focus-within:ring-2 focus-within:ring-Blue-500 focus-within:ring-offset-2 focus-within:ring-offset-NeutralBlue-900"
          >
            Search
          </button>
        </form>
          ...
          <div className="lg:flex lg:gap-8 lg:mt-4">
            <div className="lg:w-2/3">
              <section className="mt-8">
                <div className={`${loadingWeather ? "bg-NeutralBlue-800 animate-pulse" : "lg:p-8 bg-[url('./assets/images/bg-today-small.svg')] lg:bg-[url('./assets/images/bg-today-large.svg')]"}
                  flex flex-col lg:flex-row items-center justify-center p-4 h-72 w-full bg-cover bg-no-repeat rounded-2xl`}>
                 {loadingWeather ? 
                   (<div className="flex flex-col items-center justify-center gap-2">
                     <img src={iconDots} className="w-16" />
              ...
              <section className="mt-8">
                ...
                <div className="grid grid-cols-3 lg:grid-cols-7 gap-4 mt-4">
                  {(loadingWeather
                    ? Array.from({ length: DAILY_SKELETON_COUNT }, (_, index) => ({
                        dayShort: `day-${index}`,
                        icon: "",
                        altIcon: "",
                        max: "",
            ...
            <section className={`${loadingWeather && 'animate-pulse'}
      ...
      <main className="px-4 pt-4 pb-10 flex flex-col items-center lg:px-20">
        ...
        <button className="flex gap-2 py-2 px-4 mt-4 rounded-lg bg-NeutralBlue-800 text-NeutralWhite-0 cursor-pointer">
